				...
				<div className="library__title">
				 ...
				 <div className="grid-container">
				  	<div className="grid-item">
						...
						<button type="button" className="btn btn-grid" onClick={() => navigate("/stories/The-Wizard's-Guide-to-Coffee-Brewing")} >
							<span className="text aktuelles">The Wizard's Guide to Coffee Brewing</span>
						</button>
					</div>
				  	<div className="grid-item">
					 	<img src="home-pictures/big-1.jpg" alt="big img 1" />
						<button type="button" className="btn btn-grid" onClick={() => navigate("/stories/The-Chronicles-of-Narnia:-The-Wardrobe-Strikes-Back")} >
					...
					<button type="button" className="btn btn-grid" onClick={() => navigate("/stories/How-to-Train-Your-Human")} >
						<span className="text about">How to Train Your Human</span>
					</button>
					</div>
				  	<div className="grid-item">
					 	<img src="home-pictures/horizontal-1.jpg" alt="horizontal img 1" />
						<button type="button" className="btn btn-grid" onClick={() => navigate("/stories/The-Enchanted-Elbow:-A-Tale-of-Magic-and-Awkwardness")} >
				  	...
				  	<div className="grid-item">
						...
						<button type="button" className="btn btn-grid" onClick={() => navigate("/stories/The-Sorcerer's-Incredibly-Long-To-Do-List")} >
